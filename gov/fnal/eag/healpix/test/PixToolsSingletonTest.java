...
public class PixToolsSingletonTest extends TestCase {
...
//
    ...
    public void testAngDist() throws Exception {
        ...
        double res1 = PixTools.getInstance().AngDist(v1, v2);
        ...
        double res3 = PixTools.getInstance().AngDist(v3, v4);
...
//
    ...
    public void testSurfaceTriangle() throws Exception {
        ...
        double res = PixTools.getInstance().SurfaceTriangle(v1, v2, v3);
    ...
    public void testNside2Npix() {
        ...
        npix = (int) PixTools.getInstance().Nside2Npix(nside);
    ...
    public void testNpix2Nside() {
        ...
        nside = (int) PixTools.getInstance().Npix2Nside(npix);

        double pixSize1 = PixTools.getInstance().PixRes(65536);
        long nside1 = PixTools.getInstance().GetNSide(pixSize1);
    ...
    public void testVec2Ang() {
        ...
        double[] ang_tup = { 0., 0. };
        ang_tup = PixTools.getInstance().Vect2Ang(v);
    ...
    public void testAng2Pix() throws Exception {
        ...
        try {
            pix =  PixTools.getInstance().ang2pix_ring(nside,theta, phi);
        } catch (Exception e) {
            e.printStackTrace();
        }
        Vector3d v = PixTools.getInstance().Ang2Vec(theta,phi);
        long pix1 =  PixTools.getInstance().vect2pix_ring(nside,v);
        assertEquals("pix=" + pix, pix1, pix, 1e-10);
        assertEquals("pix=" + pix, 76, pix, 1e-10);

        long pix2 =  PixTools.getInstance().ang2pix_nest(nside,theta,phi);
        long pix3 =  PixTools.getInstance().vect2pix_nest(nside,v);
        assertEquals("pix2=" + pix2, pix3, pix2, 1e-10);
        assertEquals("pix2=" + pix2, 92, pix2, 1e-10);


        double[] radec = PixTools.getInstance().pix2ang_ring(nside,76);
        assertEquals("theta=" + theta, theta, radec[0], 4e-2);
        assertEquals("phi=" + phi, radec[1], phi, 1e-2);
        double[] radec1 = PixTools.getInstance().pix2ang_nest(nside,92);
    ...
    public void testRingNum() throws Exception {
        ...
        int nring = (int) PixTools.getInstance().RingNum(nside, z);
        System.out.println("z=" + z + " ring number =" + nring);
        assertEquals("z=" + z, 2, nring, 1e-10);
        z = -0.25;
        nring = (int) PixTools.getInstance().RingNum(nside, z);
        assertEquals("z=" + z, 2, nring, 1e-10);
        z = 0.8;
        nring = (int) PixTools.getInstance().RingNum(nside, z);
        ...
        nside = 4;
        int pix = 3;
        Vector3d v = PixTools.getInstance().pix2vect_ring(nside, pix);
        z = v.z;
        nring = (int) PixTools.getInstance().RingNum(nside, z);
        assertEquals("z=" + z, 1, nring, 1e-10);
        pix = 11;
        v = PixTools.getInstance().pix2vect_ring(nside, pix);
        z = v.z;
        nring = (int) PixTools.getInstance().RingNum(nside, z);
        assertEquals("z=" + z, 2, nring, 1e-10);
        pix = 23;
    ...
    public void testNest2Ring() throws Exception {
        ...
        int ipnest = 3;
        int nside = 2;
        int ipring = (int) PixTools.getInstance().nest2ring(nside, ipnest);
        assertEquals("ipring=" + ipring, 0, ipring, 1e-10);
        ipnest = 0;
        nside = 2;
        ipring = (int) PixTools.getInstance().nest2ring(nside, ipnest);
    ...
    public void testRing2Nest() throws Exception {
        ...
        int ipnest = (int) PixTools.getInstance().ring2nest(nside, ipring);
        assertEquals("ipnest=" + ipnest, 3, ipnest, 1e-10);
        ipring = 13;
        nside = 2;
        ipnest = (int) PixTools.getInstance().ring2nest(nside, ipring);
    ...
    public void testNext_In_Line_Nest() throws Exception {
        ...
        int ipix = 0;
        int nside = 2;
        int ipnext = (int) PixTools.getInstance().next_in_line_nest(nside, ipix);
        assertEquals("ipnext=" + ipnext, 23, ipnext, 1e-10);
        ipix = 1;
        nside = 2;
        ipnext = (int) PixTools.getInstance().next_in_line_nest(nside, ipix);
    ...
    public void testInRing() throws Exception {
        ...
        double phi = PI;
        double dphi = PI;
        ArrayList ring = PixTools.getInstance().InRing(nside, iz, phi, dphi, nest);
        ...
        ang_tup = PixTools.getInstance().Vect2Ang(v);
        phi = ang_tup[1]/PI;
        ring = PixTools.getInstance().InRing(nside, iz, phi, dphi, nest);
        for (int i = 0; i < ring.size(); i++) {
            assertEquals("ipnext = " + ((Long) ring.get(i)).longValue(),
                    i + 12, ((Long) ring.get(i)).longValue(), 1e-10);
        }
        ...
        ang_tup = PixTools.getInstance().Vect2Ang(v1);
        phi = ang_tup[1]/PI;
        ring = PixTools.getInstance().InRing(nside, iz, phi, dphi, nest);
        for (int i = 0; i < ring.size(); i++) {
            assertEquals("ipnext = " + ((Long) ring.get(i)).longValue(),
    ...
    public void testNeighbours_Nest() throws Exception {
        ...
        npixList = PixTools.getInstance().neighbours_nest(nside, ipix);
    ...
    public void testIntrs_Intrv() throws Exception {
        ...
        di = PixTools.getInstance().intrs_intrv(d1, d2);
    ...
    public void testPix2Vect_ring() throws Exception {
        ...
        v1 = PixTools.getInstance().pix2vect_ring(nside, ipix);
        assertEquals("v1.z = " + v1.z, 1.0, v1.z, 1e-1);

        ipix = 20;
        Vector3d v2 = new Vector3d(0., 0., 0.);
        v2 = PixTools.getInstance().pix2vect_ring(nside, ipix);
        assertEquals("v2.x = " + v2.x, 1.0, v2.x, 1e-1);
        assertEquals("v2.z = " + v2.z, 0.0, v2.z, 1e-1);
        ipix = 22;
        Vector3d v3 = new Vector3d();
        v3 = PixTools.getInstance().pix2vect_ring(nside, ipix);
        ...
        tetphi = PixTools.getInstance().pix2ang_ring(nside, ipix);
    ...
    public void testPix2Vect_nest() throws Exception {
        ...
        Vector3d v1 = new Vector3d(0., 0., 0.);
        v1 = PixTools.getInstance().pix2vect_nest(nside, ipix);
        assertEquals("v1.z = " + v1.z, 1.0, v1.z, 1e-1);
        ipix = 17;
        Vector3d v2 = new Vector3d(0., 0., 0.);
        v2 = PixTools.getInstance().pix2vect_nest(nside, ipix);
        assertEquals("v2.x = " + v2.x, 1.0, v2.x, 1e-1);
        assertEquals("v2.z = " + v2.z, 0.0, v2.z, 1e-1);

        ipix = 21;
        Vector3d v3 = new Vector3d();
        v3 = PixTools.getInstance().pix2vect_nest(nside, ipix);
        assertEquals("v3.y = " + v3.y, 1.0, v3.y, 1e-1);
        assertEquals("v3.z = " + v3.z, 0.0, v3.z, 1e-1);
        nside = 4;
        ipix = 105;
        ...
        if (phi1 < 0.)
            phi1 += TWOPI;
        double[] tetphi = new double[2];
        tetphi = PixTools.getInstance().pix2ang_nest(nside, ipix);
        assertEquals("phi = " + phi1, 0.0, Math.abs(phi1 - tetphi[1]), 1e-10);
        nside = 4;
        ipix = 74;
        v1 = PixTools.getInstance().pix2vect_nest(nside, ipix);
    ...
    public void testVect2Pix_ring() throws Exception {
        ...
        Vector3d v1 = new Vector3d(0., 0., 0.);
        v1 = PixTools.getInstance().pix2vect_ring(nside, ipix);
        respix = (int) PixTools.getInstance().vect2pix_ring(nside, v1);
        assertEquals("respix = " + respix, 83, respix, 1e-10);
        // Hi resolution test
        long nside1 = 1 << 20;
        long maxpix= PixTools.getInstance().Nside2Npix(nside1);
        System.out.println("nside="+nside1+" maxpix="+maxpix);
        Vector3d v2 = new Vector3d( -0.704, 0.580, 0.408);
        respix = PixTools.getInstance().vect2pix_ring(nside1, v2);  // ring pixel
        long respixN = PixTools.getInstance().ring2nest(nside1, respix); // convert to nest
        long respixNC = PixTools.getInstance().vect2pix_nest(nside1,v2); // nest pixel from the same vector
        long respixR = PixTools.getInstance().nest2ring(nside1, respixN); // convert pixel 
    ...
    public void testVect2Pix_nest() throws Exception {
        ...
        Vector3d v1 = new Vector3d(0., 0., 0.);
        v1 = PixTools.getInstance().pix2vect_ring(nside, ipix);
        respix = (int) PixTools.getInstance().vect2pix_nest(nside, v1);
        ...
        System.out.println("nside="+nside1+" maxpix="+maxpix);
        Vector3d v2 = new Vector3d( -0.704, 0.580, 0.408);
        respix = PixTools.getInstance().vect2pix_nest(nside1, v2);
        long respixRC = PixTools.getInstance().vect2pix_ring(nside1, v2);
        long respixR = PixTools.getInstance().nest2ring(nside1, respix);
        long respixN = PixTools.getInstance().ring2nest(nside1, respixRC);
    ...
    public void testQuery_Strip() throws Exception {
        ...
        ArrayList pixlist;
        pixlist = PixTools.getInstance().query_strip(nside, theta1, theta2, nest);
    ...
    public void testQuery_Disc() throws Exception {
        ...
        Vector3d v = PixTools.getInstance().pix2vect_ring(nside, 93);
        ArrayList pixlist;
        pixlist = PixTools.getInstance().query_disc(nside, v, radius, nest, inclusive);
...
//          System.out.println("i="+i+"pixel="+ipix+" pixel1="+pixel1[i]);
        ...
        nest = 0;
        v = new Vector3d(1.0,0.0,0.0);
        ArrayList pixlistT = PixTools.getInstance().query_disc(2, v, radius, nest, inclusive);

        radius = Math.PI / 8.0;
        v = PixTools.getInstance().pix2vect_ring(nside, 93);
        nest = 1;
        ArrayList pixlist2 = PixTools.getInstance().query_disc(nside, v, radius, nest, inclusive);
        
        int nlist2 = pixlist2.size();

        assertEquals("npix="+nlist, nlist2, pixel2.length, 1e-10);
        for (int i = 0; i < nlist2; i++) {
            ipix = ((Long) pixlist2.get(i)).longValue();
//            System.out.println("i="+i+"pixel="+ipix+" pixel2="+pixel2[i]);
            assertEquals("pixel = " + ipix, pixel2[i], ipix, 1e-10);

        }

        v = PixTools.getInstance().pix2vect_ring(nside, 103);
        nest = 1;
        inclusive = 1;
        ArrayList pixlist3 = PixTools.getInstance().query_disc(nside, v, radius, nest, inclusive);
        nlist = pixlist3.size();
        assertEquals("npix="+nlist, nlist, pixel3.length, 1e-10);
        
        for (int i = 0; i < pixlist3.size(); i++) {
            ipix = ((Long) pixlist3.get(i)).longValue();
//            System.out.println("i="+i+"pixel="+ipix+" pixel3="+pixel3[i]);
        ...
        for (int i=0; i<pixel1.length; i++) {
            long ipixR = pixel1[i]; 
            long ipixT = PixTools.getInstance().ring2nest(nside, ipixR);
            assertEquals("pixel="+ipixT, ipixT, pixel2[i], 1e-10);
            long ipixN = PixTools.getInstance().nest2ring(nside, ipixT);
    ...
    public void testQuery_Triangle() throws Exception {
        ...
        Vector3d v11 = PixTools.getInstance().pix2vect_ring(nside, pix1);

        Vector3d v22 = PixTools.getInstance().pix2vect_ring(nside, pix2);

        Vector3d v33 = PixTools.getInstance().pix2vect_ring(nside, pix3);
        ...
        ArrayList pixlist;
        pixlist = PixTools.getInstance().query_triangle(nside, v11, v22, v33, nest, inclusive);
        ...
        pix2 = 88;
        pix3 = 154;
        v11 = PixTools.getInstance().pix2vect_ring(nside, pix1);
        v22 = PixTools.getInstance().pix2vect_ring(nside, pix2);
        v33 = PixTools.getInstance().pix2vect_ring(nside, pix3);

        inclusive = 0;
        ArrayList pixlist1;
        pixlist1 = PixTools.getInstance().query_triangle(nside, v11, v22, v33, nest, inclusive);
...
//          System.out.println(ipix);
        ...
        inclusive = 0;
        ArrayList pixlist2;
        pixlist2 = PixTools.getInstance().query_triangle(nside, v11, v22, v33, nest, inclusive);
...
//            System.out.println("ipix="+ipix);
    ...
    public void testQuery_Polygon() throws Exception {
        ...
        Vector3d v = PixTools.getInstance().pix2vect_ring(nside, 53);
        vlist.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 51);
        vlist.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 82);
        vlist.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 115);
        vlist.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 117);
        vlist.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 86);
        vlist.add( v);

        ArrayList pixlist;
        pixlist = PixTools.getInstance().query_polygon(nside, vlist, nest, inclusive);
        ...
        v = PixTools.getInstance().pix2vect_ring(nside, 71);
        vlist1.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 55);
        vlist1.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 70);
        vlist1.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 87);
        vlist1.add( v);
        pixlist = PixTools.getInstance().query_polygon(nside, vlist1, nest, inclusive);
        ...
        v = PixTools.getInstance().pix2vect_ring(nside, 153);
        vlist2.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 137);
        vlist2.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 152);
        vlist2.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 168);
        vlist2.add( v);
        pixlist = PixTools.getInstance().query_polygon(nside, vlist2, nest, inclusive);
        ...
        v = PixTools.getInstance().pix2vect_ring(nside, 110);
        vlist3.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 27);
        vlist3.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 105);
        vlist3.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 154);
        vlist3.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 123);
        vlist3.add( v);
        v = PixTools.getInstance().pix2vect_ring(nside, 156);
        vlist3.add( v);
        pixlist = PixTools.getInstance().query_polygon(nside, vlist3, nest, inclusive);
    ...
    public void testQueryDiscRes() throws Exception {
        ...
        long nside = PixTools.getInstance().GetNSide(radius);
        System.out.println(" calculated nside="+nside);
        long cpix = PixTools.getInstance().ang2pix_ring(nside,theta,phi);
        Vector3d vc = PixTools.getInstance().pix2vect_ring(nside, cpix);
        ArrayList pixlist;
        pixlist = PixTools.getInstance().query_disc(nside, vc, radius, nest, inclusive);

        int nlist = pixlist.size();
        for (int i = 0; i < nlist; i++) {
            ipix = ((Long) pixlist.get(i)).longValue();
            Vector3d v = PixTools.getInstance().pix2vect_ring(nside,ipix);
            double dist = PixTools.getInstance().AngDist(v,vc);
            assertTrue(dist<=2.*radius);
        }
        cpix = PixTools.getInstance().ang2pix_nest(nside,theta,phi);
        Vector3d vc1 = PixTools.getInstance().pix2vect_nest(nside, cpix);
        ArrayList pixlist1;
        nest = 1;
        radius *=4;
        pixlist1 = PixTools.getInstance().query_disc(nside, vc1, radius, nest, inclusive);
        int nlist1 = pixlist1.size();
        for (int i = 0; i < nlist1; i++) {
            ipix = ((Long) pixlist1.get(i)).longValue();
            Vector3d v = PixTools.getInstance().pix2vect_nest(nside,ipix);
            double dist = PixTools.getInstance().AngDist(v,vc1);
            assertTrue(dist<=2.*radius);
        }
    ...
    public void testQuery_disk2() {
        ...
        ArrayList diskQ = PixTools.getInstance().query_disc(nside,
                v1,
                radius, 1,1);  // inclusive query at vector point
        assertEquals("npixels = " + diskQ.size(), 8, diskQ.size() , 1e-1);
        long pix1 = PixTools.getInstance().vect2pix_nest(nside, v1);
        Vector3d v2 = PixTools.getInstance().pix2vect_nest(nside, pix1);  // vector to pix center
        //
        ArrayList diskQ2 = PixTools.getInstance().query_disc(nside,
                v2,
                radius, 1,1);  // inclusive with point at pixel center
        assertEquals("npixels = " + diskQ2.size(), 9, diskQ2.size() , 1e-1);

        //
        ArrayList diskQ3 = PixTools.getInstance().query_disc(nside,
                v2,
 ...
 //   RING schema   
        ...
        ArrayList diskQ4 = PixTools.getInstance().query_disc(nside,
                v1,
                radius, 0,1);   // inclusiv at vector point 
        assertEquals("npixels = " + diskQ4.size(), 8, diskQ4.size() , 1e-1);
        //
  
        ArrayList diskQ5 = PixTools.getInstance().query_disc(nside,
                v2,
...
//      System.out.println("n pixels in disk5 ="+diskQ5.size());
        ArrayList diskQ6 = PixTools.getInstance().query_disc(nside,
                v2,
...
//      
        ...
        ArrayList nestPixels = PixTools.getInstance().query_disc(nside, pos, radius, 1, 1);
        ArrayList ringPixels = PixTools.getInstance().query_disc(nside, pos, radius, 0, 1);
        assertEquals(nestPixels.size(), ringPixels.size());
        for(int i=0; i< ringPixels.size(); i++) {
            long iring = ((Number)ringPixels.get(i)).longValue();
            Vector3d cv = PixTools.getInstance().pix2vect_ring(nside, iring);
            long inest = PixTools.getInstance().ring2nest(nside, iring);
            long inestC = ((Number)nestPixels.get(i)).longValue();
            Vector3d cvN = PixTools.getInstance().pix2vect_nest(nside, inestC);
            long iringT = PixTools.getInstance().nest2ring(nside, inestC);
...
//          System.out.println("Vector cv vs cvN z="+cv.z+" cvN.z="+cvN.z);
            double[] tetphiR = PixTools.getInstance().pix2ang_ring(nside, iring);
            double[] tetphiN= PixTools.getInstance().pix2ang_nest(nside, inestC);
...
//          System.out.println("phi R vs N "+tetphiR[1]+" "+tetphiN[1]);
    ...
    public void testGetNside() {
        ...
        double pixsize = 0.3;
        long nside = PixTools.getInstance().GetNSide(pixsize);
    ...
    public void testRaDecToPolar() {
        ...
        radec[0] = 312.115456;
        radec[1] = -1.153759;
        double[] polar = PixTools.getInstance().RaDecToPolar(radec);
